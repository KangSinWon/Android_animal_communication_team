...
public class DBSearchActivity extends AppCompatActivity {
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(DBSearchActivity.this,
        ...
        protected String doInBackground(String... params) {
            ...
            String serverURL = "http://210.115.48.93:8888/search.php";
            String postParameters = "bigarea=" + searchKeyword1 + "&smallarea=" + searchKeyword2;
    ...
    private void showResult(){
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    DBSearchActivity.this, mArrayList, R.layout.item_list,
